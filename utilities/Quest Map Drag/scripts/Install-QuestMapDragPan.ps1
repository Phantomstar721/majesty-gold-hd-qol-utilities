...
function Get-QuestMapDragProfiles {
    # These signatures are the untouched entry bytes of the stock quest-map
    # rebuild routine. They remain stable when other QoL utilities patch or
    # append to the executable, unlike a whole-file hash.
    return @(
        [pscustomobject]@{
            Id = "public"
